import { BookOpen, CalendarCheck, FolderKanban, LayoutDashboard, MessageSquareText, Send, type LucideIcon } from "lucide-react";
    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-footer">
          ...
          <span>{settings.targetName} · 数据本地保存</span>
        </div>
      </aside>
      <main className="main">
